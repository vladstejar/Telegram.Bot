...
public class SendingDocumentMessageTests
{
    ...
    public async Task Should_Send_Pdf_Document()
    {
        ...
        Message message = await BotClient.SendDocumentAsync(
            ...
            document: InputFile.FromStream(stream, fileName: "HAMLET.pdf"),
    ...
    public async Task Should_Send_Document_With_Farsi_Name()
    {
        ...
        Message message = await BotClient.SendDocumentAsync(
            chatId: _fixture.SupergroupChat.Id,
            document: InputFile.FromStream(stream, fileName: "هملت.pdf"),
            caption: "تراژدی هملت\nشاهزاده دانمارک"
        );
    ...
    public async Task Should_Send_Document_With_Thumb()
    {
        ...
        Message message = await BotClient.SendDocumentAsync(
            ...
            document: InputFile.FromStream(documentStream, fileName: "Hamlet.pdf"),
            thumbnail: InputFile.FromStream(thumbStream, fileName: "thumb.jpg")
        );
