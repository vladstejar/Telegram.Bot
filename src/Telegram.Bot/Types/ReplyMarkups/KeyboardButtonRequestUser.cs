...
public class KeyboardButtonRequestUser
{
    ...
    /// <summary>
    /// Optional. Pass <see langword="true" /> to request a bot, pass <see langword="false" /> to request a regular
    ...
    /// <summary>
    /// Optional. Pass <see langword="true" /> to request a premium user, pass <see langword="false" /> to request
