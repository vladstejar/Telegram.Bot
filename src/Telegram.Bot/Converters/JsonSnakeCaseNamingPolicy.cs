...
internal sealed class JsonSnakeCaseLowerNamingPolicy : JsonNamingPolicy
{
    ...
    public override string ConvertName(string name)
    {
        ...
        return ConvertNameCore(Separator, name.AsSpan());
    }

    private static string ConvertNameCore(char separator, ReadOnlySpan<char> chars)
    {
